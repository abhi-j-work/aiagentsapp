  ...
  import { 
    ...
    BarChart3, Database, Layers, Workflow // <-- 1. IMPORT THE NEW ICON
  } from 'lucide-react';

  // ===================================================
  // Reusable Feature Card Component (Unchanged)
  // ===================================================
      ...
      <>
        <style>{`
          ...
          @supports not (backdrop-filter: blur(12px)) {
            .glass-card {
              background-color: rgba(30, 41, 59, 0.9) !important; /* Fallback */
            }
          }
          @keyframes slide-up {
          ...
          <section className="py-20 relative text-slate-200">
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                {/* --- 2. THE NEW AGENT CARD IS ADDED HERE --- */}
                <div className="animate-slide-up" style={{ animationDelay: '400ms' }}>
                  <FeatureCard
                    icon={<Workflow className="h-5 w-5 text-green-400" />}
                ...
                {/* This one is now last, with an adjusted animation delay */}
