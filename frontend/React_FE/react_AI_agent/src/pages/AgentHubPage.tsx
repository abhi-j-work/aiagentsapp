  ...
  import { 
    ShieldCheck, MessageSquareQuote, Sparkles, Check, 
    BarChart3, Database, Layers 
  } from 'lucide-react';

  // ===================================================
  // 1. Reusable Feature Card Component (with height fix)
  // ===================================================
  ...
  const FeatureCard = ({ icon, title, description, features, linkTo, colorClass, glowColor }: FeatureCardProps) => (
    <div
      className="glass-card-wrapper h-full rounded-xl"
  ...
  // ===================================================
  // 2. Main Page Component (No changes needed below)
  // ===================================================
          ...
          <section className="py-20 relative text-slate-200">
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                {/* === ROW 2: NEWLY ADDED AGENTS === */}
                <div className="animate-slide-up" style={{ animationDelay: '400ms' }}>
                  <FeatureCard
                    icon={<BarChart3 className="h-5 w-5 text-teal-400" />}
                    title="AI Data Visualization"
                    description="Transform raw data into compelling charts and dashboards using simple natural language prompts."
                    features={["Natural Language Charting", "Interactive Dashboards", "Automated Insight Discovery"]}
                    linkTo="/data-visual-console"
                    colorClass="teal"
                    glowColor="#14b8a6" // Tailwind's teal-500data-visual-console
                  />
                </div>
                ...
                <div className="animate-slide-up" style={{ animationDelay: '500ms' }}>
                  <FeatureCard
                    ...
                    description="Explore your data catalog with smart search. Get AI-powered summaries, column details, and lineage."
                    features={["Smart Catalog Search", "AI-Generated Documentation", "Visual Data Lineage"]}
                    linkTo="/metadata-search"
                    colorClass="blue"
                    glowColor="#3b82f6" // Tailwind's blue-500
                  />
                </div>
                ...
                <div className="animate-slide-up" style={{ animationDelay: '600ms' }}>
                  <FeatureCard
                      ...
                      description="Apply intelligent governance directly to Apache Iceberg tables, including automated classification and access control."
                      features={["Direct Iceberg Integration", "Time-Travel Auditing", "Automated Tagging & Policies"]}
                      linkTo="/iceberg-governance"
                      colorClass="rose"
                      glowColor="#f43f5e" // Tailwind's rose-500
                  />
                </div>
              </div>
            </div>
