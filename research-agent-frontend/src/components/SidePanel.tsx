  ...
  // Types - these are now used in our props definition
  import type { ViewMode } from "../App";
  import type { GraphDataPayload } from "../models";

  const API_URL = "http://localhost:8000";

  // --- THIS IS THE NEWLY ADDED INTERFACE ---
  // It defines the shape of the props object that SidePanel expects to receive.
      ...
      >
        ...
        >
          ...
          <span className="file-input-text">
            {selectedFile ? selectedFile.name : (isDragActive ? "Drop the file here" : "Drag & drop or click")}
          </span>
        </motion.div>
